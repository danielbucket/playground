...
"use strict";
module.exports = __webpack_require__.p + "213af9a08b3780819fd3.jpg";
...
"use strict";
module.exports = __webpack_require__.p + "5bc7a549ccb9e7288f69.jpeg";
...
function prefix (value, length, children) {
	switch (hash(value, length)) {
		...
		// align-self
		case 5443:
			return WEBKIT + value + MS + 'flex-item-' + Utility_replace(value, /flex-|-self/g, '') + (!match(value, /flex-|baseline/) ? MS + 'grid-row-' + Utility_replace(value, /flex-|-self/g, '') : '') + value
		// align-content
		case 4675:
			return WEBKIT + value + MS + 'flex-line-pack' + Utility_replace(value, /align-content|flex-|-self/g, '') + value
		// flex-shrink
		case 5548:
		...
		case 2592: case 3360:
			return MS + Utility_replace(value, 'template-', '') + value
		// grid-(row|column)-start
		case 4384: case 3616:
			if (children && children.some(function (element, index) { return length = index, match(element.props, /grid-\w+-end/) })) {
				return ~indexof(value + (children = children[length].value), 'span', 0) ? value : (MS + Utility_replace(value, '-start', '') + value + MS + 'grid-row-span:' + (~indexof(children, 'span', 0) ? match(children, /\d+/) : +match(children, /\d+/) - +match(value, /\d+/)) + ';')
			}
			return MS + Utility_replace(value, '-start', '') + value
		// grid-(row|column)-end
		case 4896: case 4128:
			return (children && children.some(function (element) { return match(element.props, /grid-\w+-start/) })) ? value : MS + Utility_replace(Utility_replace(value, '-end', '-span'), 'span ', '') + value
		...
		case 5533: case 5789: case 5021: case 4765:
			...
			if (Utility_strlen(value) - 1 - length > 6)
				switch (Utility_charat(value, length + 1)) {
					...
					// (s)tretch
					case 115:
						return ~indexof(value, 'stretch', 0) ? prefix(Utility_replace(value, 'stretch', 'fill-available'), length, children) + value : value
				}
			break
		// grid-(column|row)
		case 5152: case 5920:
			return Utility_replace(value, /(.+?):(\d+)(\s*\/\s*(span)?\s*(\d+))?(.*)/, function (_, a, b, c, d, e, f) { return (MS + a + ':' + b + f) + (c ? (MS + a + '-span:' + (d ? e : +e - +b)) + f : '') + value })
		// position: sticky
		case 4949:
			// stick(y)?
		...
		case 6444:
			switch (Utility_charat(value, Utility_charat(value, 14) === 45 ? 18 : 11)) {
				// (inline-)?fle(x)
				case 120:
					return Utility_replace(value, /(.+:)([^;\s!]+)(;|(\s+)?!.+)?/, '$1' + WEBKIT + (Utility_charat(value, 14) === 45 ? 'inline-' : '') + 'box$3' + '$1' + WEBKIT + '$2$3' + '$1' + MS + '$2box$3') + value
				// (inline-)?gri(d)
				case 100:
					return Utility_replace(value, ':', ':' + MS) + value
			}
			break
		// scroll-margin, scroll-margin-(top|right|bottom|left)
		case 5719: case 2647: case 2135: case 3927: case 2391:
			return Utility_replace(value, 'scroll-', 'scroll-snap-') + value
	}
						...
						return Utility_combine(children = element.props, function (value) {
							switch (match(value, callback = /(::plac\w+|:read-\w+)/)) {
								...
								case ':read-only': case ':read-write':
									lift(copy(element, {props: [Utility_replace(value, /:(read-\w+)/, ':' + MOZ + '$1')]}))
									lift(copy(element, {props: [value]}))
									Utility_assign(element, {props: filter(children, callback)})
									break
								// :placeholder
								case '::placeholder':
									lift(copy(element, {props: [Utility_replace(value, /:(plac\w+)/, ':' + WEBKIT + 'input-$1')]}))
									lift(copy(element, {props: [Utility_replace(value, /:(plac\w+)/, ':' + MOZ + '$1')]}))
									lift(copy(element, {props: [Utility_replace(value, /:(plac\w+)/, MS + 'input-$1')]}))
									lift(copy(element, {props: [value]}))
									Utility_assign(element, {props: filter(children, callback)})
									break
							}
...
function _objectWithoutProperties(e, t) { if (null == e) return {}; var o, r, i = Navigation_objectWithoutPropertiesLoose(e, t); if (Object.getOwnPropertySymbols) { var s = Object.getOwnPropertySymbols(e); for (r = 0; r < s.length; r++) o = s[r], t.includes(o) || {}.propertyIsEnumerable.call(e, o) && (i[o] = e[o]); } return i; }
function Navigation_objectWithoutPropertiesLoose(r, e) { if (null == r) return {}; var t = {}; for (var n in r) if ({}.hasOwnProperty.call(r, n)) { if (e.includes(n)) continue; t[n] = r[n]; } return t; }


function Navigation() {
  return /*#__PURE__*/react.createElement(StyledNavigation, null, /*#__PURE__*/react.createElement(SiteTitleLink, {
    to: "/"
  }, "Bucket, LLC"), /*#__PURE__*/react.createElement(StyledUL, null, /*#__PURE__*/react.createElement(CustomLink, {
    to: "/about"
  }, "About"), /*#__PURE__*/react.createElement(CustomLink, {
    to: "/contact"
  }, "Contact"), /*#__PURE__*/react.createElement(CustomLink, {
    to: "/projects"
  }, "Projects")));
}
function CustomLink(_ref) {
  var to = _ref.to,
    ...
    props = _objectWithoutProperties(_ref, Navigation_excluded);
  return /*#__PURE__*/react.createElement(StyledLink, Navigation_extends({
    to: to
  }, props), children);
}
;// ./src/pages/Footer/index.styled.js
var index_styled_templateObject, index_styled_templateObject2;
function index_styled_taggedTemplateLiteral(e, t) { return t || (t = e.slice(0)), Object.freeze(Object.defineProperties(e, { raw: { value: Object.freeze(t) } })); }


var StyledFooter = dt.footer(index_styled_templateObject || (index_styled_templateObject = index_styled_taggedTemplateLiteral(["\n  grid-area: Footer;\n  display: flex;\n  width: 100%;\n  margin: auto;\n"])));
var index_styled_StyledLink = dt(Link)(index_styled_templateObject2 || (index_styled_templateObject2 = index_styled_taggedTemplateLiteral(["\n  text-decoration: none;\n  display: flex;\n  gap: 3rem;\n  align-items: center;\n  margin: auto;\n\n  &:hover {\n    color: #f0f0f0;\n  }\n\n  & img {\n    height: 8rem;\n  }\n\n  & p {\n    font-size: 1.25rem;\n    font-family: Ubuntu_Reg;\n  }  \n"])));
;// ./src/assets/icons/github/github-mark.png
const github_mark_namespaceObject = __webpack_require__.p + "3524c849ab38de4be923.png";
;// ./src/pages/Footer/index.jsx



function Footer() {
  return /*#__PURE__*/react.createElement(StyledFooter, null, /*#__PURE__*/react.createElement(index_styled_StyledLink, {
    to: "https://github.com/danielbucket"
  }, /*#__PURE__*/react.createElement("img", {
    src: github_mark_namespaceObject,
    alt: "GitHub icon"
  }), /*#__PURE__*/react.createElement("p", null, "@danielBucket ", /*#__PURE__*/react.createElement("span", null, "\xA9 2024"))));
}
;// ./src/root.styled.js
var root_styled_templateObject, root_styled_templateObject2, root_styled_templateObject3;
function root_styled_taggedTemplateLiteral(e, t) { return t || (t = e.slice(0)), Object.freeze(Object.defineProperties(e, { raw: { value: Object.freeze(t) } })); }

var StyledAppWrapper = dt.div(root_styled_templateObject || (root_styled_templateObject = root_styled_taggedTemplateLiteral(["\n  display: grid;\n  justify-content: center;\n  grid-template-rows:\n    [Navigation] 10rem\n    [ParentContentLayout] 1fr\n    [Footer] 8rem;\n  height: 100vh;\n  width: 100vw;\n"])));
var ParentContentLayout = dt.div(root_styled_templateObject2 || (root_styled_templateObject2 = root_styled_taggedTemplateLiteral(["\n  grid-area: ParentContentLayout;\n  padding-top: 3rem;\n  height: 100%;\n  font-family: 'Roboto';\n"])));
var AppContent = dt(ParentContentLayout)(root_styled_templateObject3 || (root_styled_templateObject3 = root_styled_taggedTemplateLiteral(["\n  & .header-container {\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n\n    & img {\n      width: 92%;\n      border-radius: 2rem;\n      margin: auto;\n      box-shadow: 0 0 0.75rem 0.3rem black;\n    }\n  }\n  \n  & .body-container {\n    flex-grow: 1;\n    width: 98%;\n    font-size: 2rem;\n    margin: 2rem auto 0 auto;\n\n    & .text-content-container {\n      margin: 1rem 0;\n      padding: 1rem;\n      background-color: #f0f0f0;\n      font-size: 2rem;\n      text-align: center;\n      border-radius: .3rem;\n    }\n  }\n"])));
;// ./src/Root.jsx
...
function Root() {
  return /*#__PURE__*/react.createElement(StyledAppWrapper, null, /*#__PURE__*/react.createElement(Navigation, null), /*#__PURE__*/react.createElement(Outlet, null), /*#__PURE__*/react.createElement(Footer, null));
}
;// ./src/pages/Home/index.styled.js
var Home_index_styled_templateObject;
function Home_index_styled_taggedTemplateLiteral(e, t) { return t || (t = e.slice(0)), Object.freeze(Object.defineProperties(e, { raw: { value: Object.freeze(t) } })); }


var StyledHomePage = dt(AppContent)(Home_index_styled_templateObject || (Home_index_styled_templateObject = Home_index_styled_taggedTemplateLiteral([""])));
;// ./src/assets/images/T100_0724.jpg
const T100_0724_namespaceObject = __webpack_require__.p + "9625c35f5ea45945e2e7.jpg";
...
function Homepage() {
  ...
  (0,react.useEffect)(function () {
    ...
    setImage(function () {
      return T100_0724_namespaceObject;
    });
  }, []);
  return /*#__PURE__*/react.createElement(StyledHomePage, null, /*#__PURE__*/react.createElement("div", {
  ...
  }, /*#__PURE__*/react.createElement("p", null, content.text))));
}
;// ./src/pages/InDev/index.styled.js
var InDev_index_styled_templateObject, InDev_index_styled_templateObject2;
function InDev_index_styled_taggedTemplateLiteral(e, t) { return t || (t = e.slice(0)), Object.freeze(Object.defineProperties(e, { raw: { value: Object.freeze(t) } })); }



var StyledNavLink = dt(NavLink)(InDev_index_styled_templateObject || (InDev_index_styled_templateObject = InDev_index_styled_taggedTemplateLiteral(["\n  color: black;\n  text-decoration: none;\n  font-size: 1.5em;\n  margin: 0 1em;\n    &:hover {\n      color: blue;\n    }\n"])));
var StyledInDevPage = dt(AppContent)(InDev_index_styled_templateObject2 || (InDev_index_styled_templateObject2 = InDev_index_styled_taggedTemplateLiteral(["\n  \n"])));
;// ./src/pages/InDev/index.jsx


var robotImage = __webpack_require__(175);
function InDev(_ref) {
  var text = _ref.text;
  return /*#__PURE__*/react.createElement(StyledInDevPage, null, /*#__PURE__*/react.createElement("div", {
    className: "header-container"
  }, /*#__PURE__*/react.createElement("img", {
    src: robotImage,
    alt: "robot image"
    ...
    className: "text-content-container"
  }, /*#__PURE__*/react.createElement("p", null, "The ", /*#__PURE__*/react.createElement("span", null, text), " page is currently in development."), /*#__PURE__*/react.createElement("p", null, "Check back later for updates."), /*#__PURE__*/react.createElement(StyledNavLink, {
    to: "/"
  }, "Click to return home"))));
}
;// ./src/pages/About/index.styled.js
var About_index_styled_templateObject;
function About_index_styled_taggedTemplateLiteral(e, t) { return t || (t = e.slice(0)), Object.freeze(Object.defineProperties(e, { raw: { value: Object.freeze(t) } })); }


var StyledAboutPage = dt(AppContent)(About_index_styled_templateObject || (About_index_styled_templateObject = About_index_styled_taggedTemplateLiteral([""])));
;// ./src/pages/About/index.jsx
function About_slicedToArray(r, e) { return About_arrayWithHoles(r) || About_iterableToArrayLimit(r, e) || About_unsupportedIterableToArray(r, e) || About_nonIterableRest(); }
function About_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function About_unsupportedIterableToArray(r, a) { if (r) { if ("string" == typeof r) return About_arrayLikeToArray(r, a); var t = {}.toString.call(r).slice(8, -1); return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? About_arrayLikeToArray(r, a) : void 0; } }
function About_arrayLikeToArray(r, a) { (null == a || a > r.length) && (a = r.length); for (var e = 0, n = Array(a); e < a; e++) n[e] = r[e]; return n; }
function About_iterableToArrayLimit(r, l) { var t = null == r ? null : "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (null != t) { var e, n, i, u, a = [], f = !0, o = !1; try { if (i = (t = t.call(r)).next, 0 === l) { if (Object(t) !== t) return; f = !1; } else for (; !(f = (e = i.call(t)).done) && (a.push(e.value), a.length !== l); f = !0); } catch (r) { o = !0, n = r; } finally { try { if (!f && null != t["return"] && (u = t["return"](), Object(u) !== u)) return; } finally { if (o) throw n; } } return a; } }
function About_arrayWithHoles(r) { if (Array.isArray(r)) return r; }



var About_image = __webpack_require__(935);
function About() {
  ...
  return /*#__PURE__*/react.createElement(StyledAboutPage, null, /*#__PURE__*/react.createElement("div", {
    className: "header-container"
  }, /*#__PURE__*/react.createElement("img", {
    src: img,
    alt: "image of Daniel Bucket"
  })), /*#__PURE__*/react.createElement("div", {
    className: "body-container"
  }, /*#__PURE__*/react.createElement("div", {
    className: "text-container"
  }, /*#__PURE__*/react.createElement("p", null, content.bio), /*#__PURE__*/react.createElement("p", null, content.name), /*#__PURE__*/react.createElement("p", null, content.title))));
}
;// ./src/pages/Contact/index.styled.js
var Contact_index_styled_templateObject, Contact_index_styled_templateObject2;
function Contact_index_styled_taggedTemplateLiteral(e, t) { return t || (t = e.slice(0)), Object.freeze(Object.defineProperties(e, { raw: { value: Object.freeze(t) } })); }


var StyledContactPage = dt(AppContent)(Contact_index_styled_templateObject || (Contact_index_styled_templateObject = Contact_index_styled_taggedTemplateLiteral([""])));
var Contact_index_styled_StyledLink = dt.button(Contact_index_styled_templateObject2 || (Contact_index_styled_templateObject2 = Contact_index_styled_taggedTemplateLiteral(["\n  background-color: #007bff;\n  border-radius: 1.75rem;\n  font-size: 3.75rem;\n  font-family: Ubuntu_Reg;\n  border: .5rem solid var(--grayd-a-grey);\n  height: 5rem;\n  width: 20rem;\n"])));
;// ./src/pages/Contact/index.jsx
var Contact_excluded = ["to", "children"];
function Contact_extends() { return Contact_extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, Contact_extends.apply(null, arguments); }
function Contact_objectWithoutProperties(e, t) { if (null == e) return {}; var o, r, i = Contact_objectWithoutPropertiesLoose(e, t); if (Object.getOwnPropertySymbols) { var s = Object.getOwnPropertySymbols(e); for (r = 0; r < s.length; r++) o = s[r], t.includes(o) || {}.propertyIsEnumerable.call(e, o) && (i[o] = e[o]); } return i; }
function Contact_objectWithoutPropertiesLoose(r, e) { if (null == r) return {}; var t = {}; for (var n in r) if ({}.hasOwnProperty.call(r, n)) { if (e.includes(n)) continue; t[n] = r[n]; } return t; }
function Contact_slicedToArray(r, e) { return Contact_arrayWithHoles(r) || Contact_iterableToArrayLimit(r, e) || Contact_unsupportedIterableToArray(r, e) || Contact_nonIterableRest(); }
function Contact_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function Contact_unsupportedIterableToArray(r, a) { if (r) { if ("string" == typeof r) return Contact_arrayLikeToArray(r, a); var t = {}.toString.call(r).slice(8, -1); return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? Contact_arrayLikeToArray(r, a) : void 0; } }
function Contact_arrayLikeToArray(r, a) { (null == a || a > r.length) && (a = r.length); for (var e = 0, n = Array(a); e < a; e++) n[e] = r[e]; return n; }
function Contact_iterableToArrayLimit(r, l) { var t = null == r ? null : "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (null != t) { var e, n, i, u, a = [], f = !0, o = !1; try { if (i = (t = t.call(r)).next, 0 === l) { if (Object(t) !== t) return; f = !1; } else for (; !(f = (e = i.call(t)).done) && (a.push(e.value), a.length !== l); f = !0); } catch (r) { o = !0, n = r; } finally { try { if (!f && null != t["return"] && (u = t["return"](), Object(u) !== u)) return; } finally { if (o) throw n; } } return a; } }
function Contact_arrayWithHoles(r) { if (Array.isArray(r)) return r; }
...
function Contact() {
  var _useState = (0,react.useState)({}),
    ...
    setContent = _useState2[1];
  var _useState3 = (0,react.useState)(null),
    _useState4 = Contact_slicedToArray(_useState3, 2),
    image = _useState4[0],
    setImage = _useState4[1];
  var _useState5 = (0,react.useState)(false),
    _useState6 = Contact_slicedToArray(_useState5, 2),
    isActive = _useState6[0],
    setIsActive = _useState6[1];
  var _useState7 = (0,react.useState)(null),
    _useState8 = Contact_slicedToArray(_useState7, 2),
    error = _useState8[0],
  ...
  function IsActiveElement() {
    return /*#__PURE__*/react.createElement("div", {
      className: "is-active-element"
    }, /*#__PURE__*/react.createElement(Contact_CustomLink, {
      onClick: handleClick
    }, "Contact Form"), /*#__PURE__*/react.createElement("p", {
      className: "bio-text"
    }, content.bio));
  }
  return /*#__PURE__*/react.createElement(StyledContactPage, null, /*#__PURE__*/react.createElement("div", {
    className: "header-container"
  }, /*#__PURE__*/react.createElement("img", {
    src: image,
    alt: "image of truck"
    ...
    className: "text-container"
  }, !isActive ? /*#__PURE__*/react.createElement(IsActiveElement, null) : /*#__PURE__*/react.createElement(Outlet, null))));
}
function Contact_CustomLink(_ref) {
  var to = _ref.to,
    children = _ref.children,
    props = Contact_objectWithoutProperties(_ref, Contact_excluded);
  return /*#__PURE__*/react.createElement(Contact_index_styled_StyledLink, Contact_extends({
    to: to
  }, props), children);
}
...
var router = createBrowserRouter([{
  ...
  errorElement: /*#__PURE__*/react.createElement("div", null, "404 Not Found"),
  children: [{
    index: true,
      ...
      var _loader = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return fetch("".concat(path, "/home/GET_content")).then(function (res) {
                return res.json();
              }).then(function (data) {
                return data;
              })["catch"](function (err) {
    ...
    loader: function () {
      var _loader2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return fetch("".concat(path, "/about/GET_content")).then(function (res) {
                return res.json();
              }).then(function (data) {
                return data;
              })["catch"](function (err) {
    ...
    path: '/contact',
    element: /*#__PURE__*/react.createElement(pages_Contact, null),
    loader: function () {
      var _loader3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return fetch("".concat(path, "/contact/GET_content")).then(function (res) {
                return res.json();
              }).then(function (data) {
                return data;
              })["catch"](function (err) {
    ...
    children: [{
      ...
      element: /*#__PURE__*/react.createElement(InDev, {
        text: 'Contact Form'
      })
    }]
  }, {
    ...
    loader: function () {
      var _loader4 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return fetch("".concat(path, "/projects/GET_content")).then(function (res) {
                return res.json();
              }).then(function (data) {
                return data;
              })["catch"](function (err) {
...
root.render(/*#__PURE__*/react.createElement(react.StrictMode, null, /*#__PURE__*/react.createElement(dist_RouterProvider, {
  router: router
